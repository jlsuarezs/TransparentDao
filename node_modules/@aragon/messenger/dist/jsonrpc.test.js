"use strict";var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault"),_ava=_interopRequireDefault(require("ava")),_sinon=_interopRequireDefault(require("sinon")),_proxyquire=_interopRequireDefault(require("proxyquire"));const uuidv4Stub=_sinon.default.stub(),jsonrpc=(0,_proxyquire.default)("./jsonrpc",{"uuid/v4":uuidv4Stub});_ava.default.afterEach.always(()=>{_sinon.default.restore()}),(0,_ava.default)("should encode the request",t=>{uuidv4Stub.returns("some-id");// act
...
t.is(encoded.jsonrpc,"2.0"),t.is(encoded.id,"1234"),t.is(encoded.error,"no-good")}),(0,_ava.default)("should return true for valid responses",t=>{// arrange
