...
var _require = require('../helpers/ipfs-daemon'),
    ...
    isIPFSRunning = _require.isIPFSRunning;
...
exports.task = function (_ref) {
  ...
  return new TaskList([{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 16:
                return _context.abrupt("return", 'Connected to IPFS daemon at port: ' + apmOptions.ipfs.rpc.port);
    ...
    task: function task(ctx) {
      ...
      var files = path.resolve(require.resolve('@aragon/aragen'), '../ipfs-cache');
