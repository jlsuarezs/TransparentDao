...
function () {
  ...
  regeneratorRuntime.mark(function _callee(_ref) {
    var reporter, network, apm, dao, app, role, entity, manager, method, params;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            reporter = _ref.reporter, network = _ref.network, apm = _ref.apm, dao = _ref.dao, app = _ref.app, role = _ref.role, entity = _ref.entity, manager = _ref.manager;
