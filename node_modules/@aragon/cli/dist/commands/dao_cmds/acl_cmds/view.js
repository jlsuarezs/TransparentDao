...
var _require4 = require('../../../util'),
    NO_MANAGER = _require4.NO_MANAGER;
...
var formatRow = function formatRow(_ref, apps) {
  ...
  var formattedManager = function () {
    var managerName = printAppName(appFromProxyAddress(manager, apps).appId, manager);
...
function () {
  ...
  regeneratorRuntime.mark(function _callee(_ref2) {
    var reporter, dao, network, apm, wsProvider, module, silent, debug, web3, tasks;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            reporter = _ref2.reporter, dao = _ref2.dao, network = _ref2.network, apm = _ref2.apm, wsProvider = _ref2.wsProvider, module = _ref2.module, silent = _ref2.silent, debug = _ref2.debug;
