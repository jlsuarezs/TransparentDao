...
function () {
  ...
  regeneratorRuntime.mark(function _callee(_ref) {
    var reporter, dao, app, role, entity, network, wsProvider, apm, method, params;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            reporter = _ref.reporter, dao = _ref.dao, app = _ref.app, role = _ref.role, entity = _ref.entity, network = _ref.network, wsProvider = _ref.wsProvider, apm = _ref.apm;
            method = 'grantPermission';
            params = [entity, app, role];
