...
function () {
  ...
  regeneratorRuntime.mark(function _callee4(_ref4) {
    var web3, reporter, dao, network, apmOptions, apmRepo, apmRepoVersion, appInit, appInitArgs, silent, debug, apm, tasks;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            web3 = _ref4.web3, reporter = _ref4.reporter, dao = _ref4.dao, network = _ref4.network, apmOptions = _ref4.apmOptions, apmRepo = _ref4.apmRepo, apmRepoVersion = _ref4.apmRepoVersion, appInit = _ref4.appInit, appInitArgs = _ref4.appInitArgs, silent = _ref4.silent, debug = _ref4.debug;
            ...
            tasks = new TaskList([{
              ...
              task: function () {
                ...
                regeneratorRuntime.mark(function _callee2(ctx) {
                  var kernel, initPayload, _ref6, events;
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        ...
                        case 8:
                          ...
                          _context2.next = 12;
                          return kernel.methods.newAppInstance(ctx.repo.appId, ctx.repo.contractAddress, initPayload, false).send({
                            from: ctx.accounts[0],
                            gasLimit: 1e6
                          });
...
function () {
  ...
  regeneratorRuntime.mark(function _callee5(_ref7) {
    var reporter, dao, network, apmOptions, apmRepo, apmRepoVersion, appInit, appInitArgs, silent, debug, web3, task;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            reporter = _ref7.reporter, dao = _ref7.dao, network = _ref7.network, apmOptions = _ref7.apm, apmRepo = _ref7.apmRepo, apmRepoVersion = _ref7.apmRepoVersion, appInit = _ref7.appInit, appInitArgs = _ref7.appInitArgs, silent = _ref7.silent, debug = _ref7.debug;
            _context5.next = 3;
