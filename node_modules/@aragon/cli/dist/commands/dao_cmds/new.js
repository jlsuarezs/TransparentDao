...
function () {
  ...
  regeneratorRuntime.mark(function _callee3(_ref) {
    var web3, reporter, apmOptions, kit, kitVersion, fn, fnArgs, skipChecks, deployEvent, kitInstance, silent, debug, apm, tasks;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            web3 = _ref.web3, reporter = _ref.reporter, apmOptions = _ref.apmOptions, kit = _ref.kit, kitVersion = _ref.kitVersion, fn = _ref.fn, fnArgs = _ref.fnArgs, skipChecks = _ref.skipChecks, deployEvent = _ref.deployEvent, kitInstance = _ref.kitInstance, silent = _ref.silent, debug = _ref.debug;
...
function () {
  ...
  regeneratorRuntime.mark(function _callee4(_ref4) {
    var reporter, network, kit, kitVersion, fn, fnArgs, deployEvent, apmOptions, silent, debug, web3, task;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            reporter = _ref4.reporter, network = _ref4.network, kit = _ref4.kit, kitVersion = _ref4.kitVersion, fn = _ref4.fn, fnArgs = _ref4.fnArgs, deployEvent = _ref4.deployEvent, apmOptions = _ref4.apm, silent = _ref4.silent, debug = _ref4.debug;
            _context4.next = 3;
