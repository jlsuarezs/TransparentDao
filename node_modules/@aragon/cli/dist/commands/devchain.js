...
function () {
  ...
  regeneratorRuntime.mark(function _callee3(_ref) {
    var _ref$port, port, _ref$reset, reset, _ref$showAccounts, showAccounts, silent, debug, removeDir, mkDir, recursiveCopy, snapshotPath, tasks;

    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _ref$port = _ref.port, port = _ref$port === void 0 ? 8545 : _ref$port, _ref$reset = _ref.reset, reset = _ref$reset === void 0 ? false : _ref$reset, _ref$showAccounts = _ref.showAccounts, showAccounts = _ref$showAccounts === void 0 ? 2 : _ref$showAccounts, silent = _ref.silent, debug = _ref.debug;
            removeDir = promisify(rimraf);
            mkDir = promisify(mkdirp);
            recursiveCopy = promisify(ncp);
            snapshotPath = path.join(os.homedir(), ".aragon/ganache-db-".concat(port));
            tasks = new TaskList([{
...
function () {
  ...
  regeneratorRuntime.mark(function _callee4(_ref4) {
    var reporter, port, reset, accounts, apmOptions, silent, debug, task, _ref6, privateKeys, mnemonic;

    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            reporter = _ref4.reporter, port = _ref4.port, reset = _ref4.reset, accounts = _ref4.accounts, apmOptions = _ref4.apm, silent = _ref4.silent, debug = _ref4.debug;
            _context4.next = 3;
            return exports.task({
              port: port,
              reset: reset,
          ...
          case 6:
            ...
            reporter.info("ENS instance deployed at ".concat(apmOptions['ens-registry'], "\n"));
