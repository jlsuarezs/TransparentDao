...
function () {
  ...
  regeneratorRuntime.mark(function _callee4(_ref) {
    var reporter, network, cwd, contract, init, web3, apmOptions, silent, debug, mappingMask, mappings, processedInit, contractName, tasks;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            reporter = _ref.reporter, network = _ref.network, cwd = _ref.cwd, contract = _ref.contract, init = _ref.init, web3 = _ref.web3, apmOptions = _ref.apmOptions, silent = _ref.silent, debug = _ref.debug;
            ...
            tasks = new TaskList([{
              ...
              task: function () {
                ...
                regeneratorRuntime.mark(function _callee2(ctx, _task2) {
                  var _ctx$contractArtifact, abi, bytecode, contract, accounts, deployTx, gas, args, deployPromise, instance;
                  ...
                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        ...
                        case 8:
                          _ctx$contractArtifact = ctx.contractArtifacts, abi = _ctx$contractArtifact.abi, bytecode = _ctx$contractArtifact.bytecode;
                        ...
                        case 19:
                          ...
                          deployPromise.on('transactionHash', function (transactionHash) {
                  ...
                  return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          _context3.next = 2;
                          return deployArtifacts(ctx.contractArtifacts);
...
function () {
  ...
  regeneratorRuntime.mark(function _callee5(_ref3) {
    var reporter, network, cwd, contract, init, apmOptions, silent, debug, task, ctx;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            reporter = _ref3.reporter, network = _ref3.network, cwd = _ref3.cwd, contract = _ref3.contract, init = _ref3.init, apmOptions = _ref3.apm, silent = _ref3.silent, debug = _ref3.debug;
            _context5.next = 3;
            return exports.task({
              reporter: reporter,
              network: network,
          ...
          case 6:
            ...
            reporter.info("Transaction hash: ".concat(ctx.deployArtifacts.transactionHash));
            process.exit();
