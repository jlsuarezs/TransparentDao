"use strict";var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault"),_addMilliseconds=_interopRequireDefault(require("date-fns/addMilliseconds")),_addSeconds=_interopRequireDefault(require("date-fns/addSeconds")),_addMinutes=_interopRequireDefault(require("date-fns/addMinutes")),_addHours=_interopRequireDefault(require("date-fns/addHours")),_addDays=_interopRequireDefault(require("date-fns/addDays")),_addWeeks=_interopRequireDefault(require("date-fns/addWeeks")),_addMonths=_interopRequireDefault(require("date-fns/addMonths")),_addYears=_interopRequireDefault(require("date-fns/addYears")),_formatDistanceStrict=_interopRequireDefault(require("date-fns/formatDistanceStrict"));const BEST_UNIT="best",ADD_UNIT_FN=new Map([["millisecond",_addMilliseconds.default],["second",_addSeconds.default],["minute",_addMinutes.default],["hour",_addHours.default],["day",_addDays.default],["week",_addWeeks.default],["month",_addMonths.default],["year",_addYears.default]]),DISALLOWED_FROM_UNITS=new Set(["millisecond"]);module.exports=()=>/**
